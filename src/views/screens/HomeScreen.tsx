		...
		<div className="h-screen flex flex-col">
			...
			<main className="w-full mx-auto px-4 lg:width-lg lg:px-0 overflow-y-auto scrollbar-hidden">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-4 h-full">
					...
					<FirstColumn className="pt-4 pb-8 pr-4 h-full overflow-y-auto scrollbar-transparent hover:scrollbar-styled transition" />
					<SecondColumn className="pt-4 pb-8 pr-4 h-full overflow-y-auto scrollbar-transparent hover:scrollbar-styled transition hidden sm:block" />
