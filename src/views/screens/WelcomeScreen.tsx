			...
			<main className="mt-4 w-full mx-auto px-4 lg:width-lg lg:px-0">
				...
				<section className="mt-4 grid grid-cols-3 gap-8">
					...
					<div className="bg-slate-100 rounded-xl p-8">
						...
						<p className="mt-2">やるべきこと・やりたいことをアプリに保存し、効率的に管理しましょう。</p>
					</div>
					...
					<div className="bg-slate-100 rounded-xl p-8">
						...
						<p className="mt-2">Todoを達成したら、アプリ内で達成済みに変更しましょう。達成したTodoは後から振り返ることができます。</p>
					</div>
					...
					<div className="bg-slate-100 rounded-xl p-8">
						...
						<p className="mt-2">日別のTodo達成数を確認し、日々やったことを振り返りましょう。</p>
					</div>
